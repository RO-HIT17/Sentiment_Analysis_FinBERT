...
def get_best_synonym(suggestions, sentence, top_k=5):
    """
    Chooses the best synonym for each masked word based on semantic similarity.
    
    Args:
        suggestions (list): List of top-k synonym suggestions.
...
if __name__ == "__main__":
    ...
    for sentence in test_sentences:
        ...
        try:
            ...
            # Get the best synonym replacements
            modified_sentence = get_best_synonym(suggestions, masked_sentence)
